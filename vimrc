...
" Sections:
"    -> General
"    -> VIM user interface "    -> Colors and Fonts
"    -> Files and backups
...
" => General
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Don't worry about compatibilty with vi
set nocompatible
...
" Change the 'go to command mode' key from ECS to jk
inoremap jk <ESC>
...
" Note: This was causing the tab bar to appear at the top
"       of the window.
